...
app.config['MAIL_USERNAME'] = 'support@manifestmy.life'
app.config['MAIL_PASSWORD'] = 'Support4MyLife'
app.config['MAIL_DEFAULT_SENDER'] = 'support@manifestmy.life'
...
class CurrentNotifications(Resource):
    def get(self, user_id):
        ...
        try:
            ...
            # Get all the notifications for the goals and routines of the user
            query = """SELECT -- *
                        n.*,
                       gr.*
            ...
            # check if the exisiting notifications fit criteria
                ...
                for notify in notificatons:
                    ...
                    if(before_time > now_time or notify['before_time'] == '00:00:00'):
                    ...
                    if(during_time > now_time or notify['during_time'] == '00:00:00'):
                        print('during time skipped', during_time > now_time,
                              notify['during_time'] == '00:00:00')
                    ...
                    if(after_time > now_time or notify['after_time'] == '00:00:00'):
...
class UploadTAImage(Resource):
    def post(self):
        print("in UploadTAImage")
        response = {}
        items = {}
        try:
            conn = connect()
            ...
            try:
                ...
                response['message'] = 'successful'
                response['result'] = 'Update Image to ta_people successful'
...
class UpdateTA(Resource):
    def post(self):
        ...
        try:
            ...
            response['message'] = 'successful'
            response['result'] = 'Update to ta_people successful'
...
api.add_resource(UploadTAImage, '/api/v2/UploadTAImage')
