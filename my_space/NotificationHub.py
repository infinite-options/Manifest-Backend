...
class AzureNotificationHub:
    ...
    def __init__(cls, connection_string=None, hub_name=None, debug=0):
        ...
        for part in parts:
            ...
            if part.startswith('SharedAccessKeyName'):
                ...
                print(cls.SasKeyName)
            if part.startswith('SharedAccessKey') and not part.startswith('SharedAccessKeyName'):
                cls.SasKeyValue = part[16:]
                print(cls.SasKeyValue)
    ...
    def send_apple_notification(self, is_direct, payload, tags="guid_e926c310-ac1f-4efc-8833-4e2b34596401", device_handle=None, scheduled_time=None,
                                skip_send=False):
    ...
    def send_google_notification(self, is_direct, payload, tags="guid_14f67531-c39a-4670-96b1-08b9a8623764", device_handle=None, scheduled_time=None,
                                 skip_send=False):
